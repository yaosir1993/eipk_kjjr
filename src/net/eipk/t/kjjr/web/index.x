		...
		$.ajax({
			  ...
			  data: { username:$("#username").val(),password:$("#password").val(),check_code:$("#check_code").val() }
				...
				if(result.id!=1){
					...
					location='#{DocumentRoot}/s/main.x';
				}
		});
	}
}
...
　　平台的建设有利于科技资源和金融资源的有效对接，对构建具有区域特色的多元化、多层次、多渠道科技金融体系具有积极意义。
	...
	<iframe name="article_frame" scrolling="auto" frameborder="0" src="#{DocumentRoot}/web/article_list.x?s_id=1" style="height:530px"></iframe>
	</div>	
			</td>
			<td style="width:400px;">
				<img src="#{DocumentRoot}/web/images/banner.png" style="width:400px;height:630px;">
...
科技信贷
	...
	<iframe name="article_frame" scrolling="auto" frameborder="0" src="#{DocumentRoot}/web/article_list.x?s_id=2" style="height:530px"></iframe>
	</div>
