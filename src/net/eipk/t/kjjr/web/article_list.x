...
<table style="width:98%">
	#Begin{article_list}
		<tr>
		<td class="tl" style="font-size:15px"> #{title}</td>
		<td rowspan="2" style="width:95px;"><a href="#{DocumentRoot}/web/article_show.x?a_id=#{id}" class="btn"><i class="iconfont">&#xe623;</i> 查看详情</a></td>
		</tr>
		<tr>
		<td class="tl" style="width:100%;color:#ccc" colspan="2"> 内容来源：#{pubUnit}　发布日期：#Date{pubDate,yyyy-MM-dd}　阅读次数：#{hits}</td>
		</tr>		
